...
def playComputer(canvas, switchIcon, info_txt, icon_bird, icon_sheep, NW, stop_computer_playing,msg_draw, msg_win, msg_lose, render_switchBtn):
    global player_play
    ...
    if(random_case in cases_computer):
        playComputer(canvas, switchIcon, info_txt, icon_bird, icon_sheep, NW, stop_computer_playing,msg_draw, msg_win, msg_lose, render_switchBtn)
        ...
        utils.verifyWin(cases_player, cases_computer, canvas, NW, msg_draw, msg_win, msg_lose, render_switchBtn)
        canvas.itemconfigure(info_txt, text="C'est à vous de jouer !")
        canvas.coords(info_txt, 180, 619)


def setCaseIcon(canvas, caseId, icon_bird, icon_sheep, NW, msg_draw, msg_win, msg_lose, render_switchBtn, info_txt):
    global player_play
    global cases_player
    global start_game
